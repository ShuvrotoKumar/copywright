      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-[#111826] px-5 py-4 rounded-lg mb-8 flex items-center justify-between shadow-md">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-white text-2xl font-bold">Subscription Plans</h1>
          </div>
          <Select
            value={statusFilter}
              ...
              >
                ...
                <div className="p-5 pt-10">
                  ...
                  <div className="mb-4">
                    <div className="flex items-baseline">
                      ...
                      <span className="text-gray-500 ml-2 text-base">
                        /{subscription.billingCycle === 'monthly' ? 'mo' : 'once'}
                      </span>
                    </div>
                    {subscription.subscriptionType === 'recurring' && (
                  ...
                  <div className="bg-blue-50 rounded-lg p-2.5 mb-4 text-center">
                    <p className="text-xs text-gray-600 mb-0.5">Account Limit</p>
                    <p className="text-xl font-bold text-blue-600">
                      {subscription.accountLimit} Account{subscription.accountLimit > 1 ? 's' : ''}
                    </p>
                  </div>
        ...
        {selectedSubscription && (
          <div className="py-4">
            <div className="mb-4 p-4 bg-gray-50 rounded-lg">
              ...
              <p className="font-semibold text-gray-900">{selectedSubscription.name}</p>
            </div>
