      ...
      <ConfigProvider
        theme={{
          components: {
            ...
            Pagination: {
              colorPrimaryBorder: "#111826",
              colorBorder: "#2563eb",
              colorPrimaryHover: "#2563eb",
              colorTextPlaceholder: "#2563eb",
              itemActiveBgDisabled: "#111826",
              colorPrimary: "#111826",
            },
            Table: {
              headerBg: "white",
        ...
        >
          {selectedUser && (
            <div className="relative">
              ...
              <div className="bg-gradient-to-r from-[#111826] to-[#111826] p-6 -m-6 mb-6 rounded-t-lg">
                    ...
                    <div className="bg-white border border-gray-200 p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                          <span className="text-[#111826] text-lg">👤</span>
                        </div>
                        <div>
                          <h4 className="text-sm font-medium text-gray-600">
                            Report From
